...
export default function PrivacyPolicy() {
  ...
  // Intersection Observer references for fade-in
  ...
  return (
    <>
      ...
      <section
        className="relative h-[60vh] flex items-center justify-center text-white bg-fixed bg-center bg-cover"
        style={{
          backgroundImage: `url('/images/leaf-pattern.svg')`,
          backgroundColor: "#56ab2f", // fallback behind pattern
        }}
      >
        {/* Overlay */}
          ...
          <section className="space-y-10">
            ...
            >
              ...
              <p className="font-body text-gray-700 leading-relaxed">
                We collect personal information, such as your name, email address, and payment
                information, to provide a seamless experience.
              </p>
            </div>
            ...
            >
              ...
              <p className="font-body text-gray-700 leading-relaxed">
                Your data is used to process orders, improve customer support, and personalize your
                experience.
              </p>
            </div>
            ...
            >
              ...
              <p className="font-body text-gray-700 leading-relaxed">
                You have the right to access, update, or delete your data. For assistance, please
                email us.
              </p>
            </div>
